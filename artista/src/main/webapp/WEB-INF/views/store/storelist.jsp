                    ...
                    <div class="scrollList">
                        <div class="list">
                            <div class="images card_list" id="itemList" style="height: 1777.55px;margin: 0 82.5px;">
                            	...
                            	<div class="image" style="width: 290px; transform: translate(${(status.index % 4) * 103}%, ${works[status.index-4] == null ? 0 : works[status.index-4].workHeight+18*((status.index-4)/4)}px);">
                            	 <div data-brackets-id="2440" class="card_b only-mb">
                                    ...
                                    <%-- <c:choose>
                                    <c:when test="${work.workForSale == 2 }"> --%>
