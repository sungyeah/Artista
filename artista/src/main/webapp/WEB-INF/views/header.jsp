				...
				$("#toggleBtn").on("click", function(){
                    ...
                    if (fundingList.length == 0) {
                        ...
                        for(let funding of fundingList) { 
                         ...
                         /* $(".box1").append('<div onclick="cnt('+funding.fundingNo+',\''+funding.id+'\')">' + funding.projTitle + funding.fundingMsg + '</div>' + '<br>') */
                        /*  $(".box1").append('<div onclick=cnt('+funding.fundingNo+')>' + funding.projTitle + funding.fundingMsg + '</div>' + '<br>') */
                        						 /* onclick="detailModal('+i.no+',\''+i.type+'\')"> */
