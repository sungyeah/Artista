...
<body>
    ...
    <div class="account-modify-form-border"></div>
        ...
        <div class="account-modify-form-row">
            ...
            <div class="account-modify-form-row-value">
                <input class="account-modify-form-input" type="text" name="getplace" id="getplace" placeholder="주소" maxlength="20" style="margin-bottom:7px;cursor:pointer" onClick=search3() value='${funding.getplace }'>
                <input class="change-password-btn" type="button" id="search" value="검색" data-mode="change" onClick=search3()><br>
                <input class="account-modify-form-input" type="text" name="getplace2" id="getplace2" placeholder="상세주소" maxlength="20" value='${funding.getplace2 }'><br>
       		</div>
       </div>
       <div class="account-modify-form-row">
            <div class="account-modify-form-row-label">
