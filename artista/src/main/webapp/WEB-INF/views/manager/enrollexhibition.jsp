...
<body>
    ...
    <div id="contents">
    	<header class="account-header">
            <h2 class="account-header-title">전시등록하기</h2>
            <div class="account-header-description">등록할 젼시 정보를 입력하세요.</div>
        </header>

        <article class="enroll-body">
            <form id="form" class="enroll-modify-form" method="post" action="/manager/exhibitionEnrollComplete" enctype="multipart/form-data">
